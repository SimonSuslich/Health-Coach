/*
  ...
  output på en OLED skärm och på en piezo som skickar ut ljudsignaler. När den Inaktiva tiden överskrider ett angivet värde, till exempel 10 sekunder skickas ut en kort ljudsignal och på Oled skärmen stårdet att man har varit fysiskt inaktiv och hur länge man har varit det. För att ställa tillbaka den inaktiva tiden till 0 måste man antingen röra på sig 
  (triggera vibrationssensorn) eller välja ett träningspass bland de inbyggda träningspassen som finns i programmet. För att välja ett träningspass ska man skrolla med en Joystick fram eller tillbaka genom listan med de olika träningspassen. Man kan trycka på Joystickens knapp för att välja träningsprogram. Det kommer skickas ut en ljudsignal varenda gång
  en övning börjar och när en övning slutar. För att visa enkelt och smidigt hur mycket tid man har på sig för att utföra en övning finns en NeoPixel LED Ring med, som gör en countdown. Man får en när ett träninspass är över
*/
